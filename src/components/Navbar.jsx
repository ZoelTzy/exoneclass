	...
	return (
		<>
			...
			<div className="flex justify-between relative top-3 lg:hidden">
				<div className="w-10 h-10 rounded-full flex justify-center items-center" id="MenuButton">
					<img src="/NavIcon.png" alt="Menu" className="w-6 h-6" onClick={toggleMenu} />
				</div>
				...
				<div className="w-10 h-10 rounded-full flex justify-center items-center" id="UserButton">
					<img src="/user.svg" alt="User" className="" />
				</div>
				...
				{/* Slide Menu */}
				<div
					className={`fixed top-0 left-0 h-full w-64 shadow-lg transform transition-transform duration-300 ease-in-out z-20 ${
			...
			<div className="justify-between relative top-3 hidden lg:flex">
				<div>
					<img src="/LogoPHI.png" className="w-12 h-12 rounded-full" alt="Logo" />
				</div>
